...
function App() {
  ...
  return (
    <div className="App">
      <MusicPlayer src="/public/assets/audio/musa.mp3" /> {/* Lisää tämä */}
      <AppRouter
        stats={stats}
        storeitems={storeitems}
        handleClick={handleClick}
...
function App() {
  ...
  const [currentMusic, setCurrentMusic] = useLocalStorage('current-music', '/assets/audio/musa.mp3');
...
function App() {
  ...
  // Tallennetaan myös musiikki, joka on valittu
  //const [currentMusic, setCurrentMusic] = useLocalStorage('current-music', '/asset/audio/musa.mp3');
